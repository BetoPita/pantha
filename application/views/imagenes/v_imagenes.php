...
<div class="row head_verde" >
    ...
    <div class="col-xs-2">
    	<h2 class="titulorow" style="margin-top:10px; color:white">Imagenes</h2>
    </div>
    <div class="btn-toolbar">
	    <div class="col-xs-6 col-sm-3 pull-right">
			<a type="button" id="js_agregar" class="btn-agregar btn btn-lg btn-block" style="background-color:#3498DB; margin-top:4px;" ><i class="fa fa-plus"></i> <span class="tituloadd">Añadir imagen</span></a>
	    </div>
    </div>
</div>
<div class="row">
	<div class="col-md-12">
		<table id="tbl_productos" class="table table-striped dataTable" cellspacing="0" width="100%">
			...
			<tbody>
				...
				<tr>
					<td><img src="<?php echo base_url($i->imagen) ?>" width="100px" alt=""></td>
...
<script src="statics/js/imagen.js"></script>
